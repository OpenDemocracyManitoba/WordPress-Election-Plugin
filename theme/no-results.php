...
<article id="post-0" class="post no-results not-found">
    ...
    <div class="entry-content">
        <?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
            ...
            <p><?php printf( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'election_data_theme' ), admin_url( 'post-new.php' ) ); ?></p>
        ...
        <?php else : ?>
            ...
            <p><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'election_data_theme' ); ?></p>
            <?php get_search_form(); ?>
